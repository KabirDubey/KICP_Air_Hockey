...
def policy(time, puckX, puckY, robotX, robotY):
	global timer_packet_old, cam_timestamp, puckCoordX, puckCoordY, robotCoordX, robotCoordY, com_pos_x, com_pos_y, max_speed, max_accel, robotCoordX, robotCoordY
	cam_timestamp, puckCoordX, puckCoordY, robotCoordX, robotCoordY = time, puckX, puckY, robotX, robotY
	timer_value = cam_timestamp
	dt = (timer_value - timer_packet_old)
